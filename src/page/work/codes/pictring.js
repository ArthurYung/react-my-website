...
const pictring1 = '//cdn-qiniu.bruceau.com/my-blog/work/pictring1.gif'
const pictring2 = '//cdn-qiniu.bruceau.com/my-blog/work/pictring2.gif'
const pictring3 = '//cdn-qiniu.bruceau.com/my-blog/work/pictring3.gif'
export default ()=> {
  return(
