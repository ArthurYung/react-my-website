...
export default ()=>{
  return(
    <article className="work-pop-main work-pop-code">
      ...
      <LazyImg w="320px" h="572px" src="//cdn-qiniu.bruceau.com/my-blog/work/ckcode.gif"/>
      <h5>简介</h5>
      ...
      <LazyImg w="320px" h="572px" src="//cdn-qiniu.bruceau.com/my-blog/work/chikenCode.png"/>
    </article> 
  )
}
