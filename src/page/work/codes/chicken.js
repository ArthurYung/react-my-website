...
import chicken from '@/images/work/ckcode.gif'
import ckCode from '@/images/work/chikenCode.png'
...
export default ()=>{
  return(
    <article className="work-pop-main work-pop-code">
      ...
      <LazyImg w="320px" h="572px" src={chicken}/>
      <h5>简介</h5>
      ...
      <LazyImg w="320px" h="572px" src={ckCode}/>
    </article> 
  )
}